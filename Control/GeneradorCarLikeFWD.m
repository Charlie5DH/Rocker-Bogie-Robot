...
%     path_y = ytp1*Re;
    ...
    Kp = 0.5;                                      %(1/seg) parametro del controlador
    %K1 = 10;                                    %parametro del controlador para TRM
    k_cita = 10;                                  %parametro del controlador
    k_fi = 15;                                   %parametro del controlador
    ...
    [u1,u2,x,y,cita,ex,ey,ecita,efi] = VFO_AckermanFWD(path_x,path_y,cita_ini_rob,xref,yref,citaref,firef,signmov,Vr,Kp,k_cita,k_fi,dt,ts,L,wheel_base,wheel_radi);
    ...
    graficar2(large,wide,Re,path_x,path_y,dt,ts,xref,yref,x,y,scaleMap,cita,citaref,u1,u2,ex,ey,ecita); %GRAFICAR
