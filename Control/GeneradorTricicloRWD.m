...
if(path_x(1) == 0)
    ...
    Kp = 2;                                      %(1/seg) parametro del controlador
...
%     citaref = ordenarArreglo(citaref);
    ...
    [u1,u2,x,y,cita,ex,ey,ecita,efi] = VFO_triciclo(path_x,path_y,cita_ini_rob,xref,yref,citaref,firef,signmov,Vr,Kp,K1,dt,ts);
